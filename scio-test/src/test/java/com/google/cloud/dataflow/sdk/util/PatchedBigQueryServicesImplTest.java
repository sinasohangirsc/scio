...
import com.google.cloud.dataflow.sdk.util.PatchedBigQueryServicesImpl.JobServiceImpl;
...
/**
 * Tests for {@link PatchedBigQueryServicesImpl}.
 */
@RunWith(JUnit4.class)
public class PatchedBigQueryServicesImplTest {
  @Rule public ExpectedException thrown = ExpectedException.none();
  @Rule public ExpectedLogs expectedLogs = ExpectedLogs.none(PatchedBigQueryServicesImpl.class);
  ...
  /**
   * Tests that {@link PatchedBigQueryServicesImpl.JobServiceImpl#startLoadJob} succeeds.
   */
  @Test
  ...
  /**
   * Tests that {@link PatchedBigQueryServicesImpl.JobServiceImpl#startLoadJob} succeeds with a retry.
   */
  @Test
  ...
  /**
   * Tests that {@link PatchedBigQueryServicesImpl.JobServiceImpl#pollJob} succeeds.
   */
  @Test
  public void testPollJobSucceeds() throws IOException, InterruptedException {
    ...
    PatchedBigQueryServicesImpl.JobServiceImpl jobService =
        new PatchedBigQueryServicesImpl.JobServiceImpl(bigquery);
    JobReference jobRef = new JobReference()
  ...
  /**
   * Tests that {@link PatchedBigQueryServicesImpl.JobServiceImpl#pollJob} fails.
   */
  @Test
  ...
  /**
   * Tests that {@link PatchedBigQueryServicesImpl.JobServiceImpl#pollJob} returns UNKNOWN.
   */
  @Test
  ...
  public void testExecuteWithRetries() throws IOException, InterruptedException {
    ...
    Table table = PatchedBigQueryServicesImpl.executeWithRetries(
